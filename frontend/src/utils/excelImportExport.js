...
export const SAMPLE_QUESTIONS = [
  {
    ...
    type: "MCQ",
    text: "When building a production multi-turn agent with tool calling, why should intermediate tool execution errors be returned in the tool message rather than raising API exceptions?",
  ...
  },
  {
    ...
    type: "MCQ",
    text: "Which geometric shape has exactly 3 straight sides and 3 corners (vertices)?",
    choiceA: "Square",
    choiceB: "Triangle",
    choiceC: "Circle",
    choiceD: "Rectangle",
